$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        emailjs.init("user_qLQQcO_I5AzTq7TJCeNJW");
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Vishnu S";
...
async function fetchData(type = "skills") {
    ...
    if (type === "skills") {
        ...
        url = "./certificates/certificates.json"; // Adjust the path accordingly
    }
...
function showCertificates(certificates) {
    ...
    /* SCROLL CERTIFICATES */
    srtop.reveal('.certi .box', { interval: 200 });
...
(function () {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/666359b8981b6c56477ab4ac/1hvq1cue0';
    s1.charset = 'UTF-8';
...
// ...
// The remaining parts of your original code are retained here as well.
// ...
